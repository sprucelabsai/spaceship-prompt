...
## Sprucebot custom Prompt

An enhanced prompt that works with the [Spruce](https://spruce.ai) platform.

<img src="logos/sprucebot-spaceship.png" />

### Installation of custom Sprucebot prompt
...
Finally, open your `~/.zshrc` file and set your theme:
...
To get a prompt that looks like the screenshot above, add these settings to the end of your `~/.zshrc` file:
